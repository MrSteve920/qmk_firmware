...
[BASE] = LAYOUT_96_ansi(\
      ...
      KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,     KC_O,    KC_P,    KC_LBRC, KC_RBRC,  TD(SLASHANDDEL), KC_P7,   KC_P8,   KC_P9, LT(ARROWS,KC_PPLS),  \
      ...
      KC_LCTL,  KC_LGUI, KC_LALT, KC_SPC,  LT(FUNCTION, KC_RALT),   KC_RCTL,                               KC_LEFT, KC_DOWN, KC_RIGHT,         KC_P0,   KC_PDOT, KC_PENT),          \

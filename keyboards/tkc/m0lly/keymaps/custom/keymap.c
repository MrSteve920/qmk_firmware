...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_all(
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, TD(SLASHANDDEL),  KC_P7,   KC_P8,   KC_P9,   XXXXXXX, \
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                      KC_RALT, KC_RWIN, TT(FUNCTION), KC_RCTL,                     KC_P0,   XXXXXXX, KC_PDOT, KC_PENT  \
  ),
   ...
   */
  [FUNCTION] = LAYOUT_all(
    KC_GRV, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12, KC_PAUS, XXXXXXX, KC_SLCK, KC_CUT , KC_COPY, KC_PSTE, \
    RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS,          _______, _______, _______, XXXXXXX, \
    RGB_RMOD,RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, _______,          _______, _______, _______, _______, \

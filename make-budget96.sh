...
sudo cp /mnt/d/Internal\ Documents/Personal\ Files/Mechanical\ Keyboards/Budget96/QMK\ Configuration/Custom/rules.mk ./keyboards/donutcables/budget96/keymaps/custom/rules.mk

...
sudo cp /mnt/d/Internal\ Documents/Personal\ Files/Mechanical\ Keyboards/M0lly/QMK\ Configuration/Custom/rules.mk ./keyboards/tkc/m0lly/keymaps/custom/rules.mk
